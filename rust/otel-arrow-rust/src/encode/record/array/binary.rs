...
use arrow::array::{
    Array, ArrowPrimitiveType, BinaryArray, BinaryBuilder, BinaryDictionaryBuilder,
...
impl<K> DictionaryArrayAppend<K> for BinaryDictionaryBuilder<K>
where
    K: ArrowDictionaryKeyType,
...
mod test {
    ...
    fn test_string_builder() {
        ...
        assert_eq!(
            result.array.as_any().downcast_ref::<BinaryArray>().unwrap(),
            &expected
        );
    }
