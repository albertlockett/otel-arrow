...
use arrow::array::{Array, ArrayRef, RecordBatch, StringArray, StructArray, UInt16Array, UInt32Array};
use arrow::datatypes::{DataType, Field, Fields};
use snafu::OptionExt;

pub struct ResourceArrays<'a> {
        // TODO fix the visbility of these, what's here might not be correct
        pub(in crate::otlp) id: &'a UInt16Array,
        pub(in crate::otlp) dropped_attributes_count: Option<&'a UInt32Array>,
        pub(in crate::otlp) schema_url: Option<StringArrayAccessor<'a>>,
}
