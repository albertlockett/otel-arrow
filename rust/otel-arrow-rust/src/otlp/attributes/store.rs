...
use crate::arrays::{
    get_binary_array_opt, get_bool_array_opt, get_f64_array_opt, get_u8_array, ByteArrayAccessor, Int64ArrayAccessor, MaybeDictArrayAccessor, NullableArrayAccessor, StringArrayAccessor
};
use crate::error;
    ...
    <<T as ParentId>::ArrayType as ArrowPrimitiveType>::Native: Into<T>,
{
    ...
    fn try_from(rb: &RecordBatch) -> Result<Self, Self::Error> {
        ...
        let value_str_arr = StringArrayAccessor::try_new_from_column(rb, consts::ATTRIBUTE_STR)?;
        let value_int_arr = Int64ArrayAccessor::try_new_from_column(rb, consts::ATTRIBUTE_INT)?;
        ...
        let value_bytes_arr = ByteArrayAccessor::try_new_from_column(rb, consts::ATTRIBUTE_BYTES)?;
